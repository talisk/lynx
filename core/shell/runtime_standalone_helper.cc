...
InitRuntimeStandaloneResult InitRuntimeStandalone(
    ...
    const lepus::Value* global_props, bool long_task_monitor_disabled, bool debuggable) {
  ...
  runtime_actor->ActAsync(
      [native_module_manager, preload_js_paths = std::move(preload_js_paths),
       ...
       vsync_monitor, debuggable](std::unique_ptr<runtime::LynxRuntime>& runtime) mutable {
